...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.i18n',  # Enable i18n context processor
            ],
        },
    },
]
...
LOCALE_PATHS = [
    os.path.join(BASE_DIR, 'website/templates/website/locale'),
]
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'real_estate_backend/static')
]
